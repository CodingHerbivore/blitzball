#include "Blitzball.bmx.gui.debug.win32.x86.h"
...
BBINT _m_Blitzball_DrawGradient(BBINT bbt_increment){
	...
	struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 21, 0};
	bbOnDebugEnterStm(&__stmt_0);
	bbt_y=0;
	struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 23, 0};
	...
	while(bbt_y<480){
		...
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 24, 0};
		bbOnDebugEnterStm(&__stmt_0);
		bbt_blueshade=(((BBFLOAT)bbt_y)/480.000000f);
		struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 25, 0};
		bbOnDebugEnterStm(&__stmt_1);
		bbt_blue=((BBINT)(192.000000f*bbt_blueshade));
		struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 26, 0};
		bbOnDebugEnterStm(&__stmt_2);
		brl_max2d_SetColor(0,0,bbt_blue);
		struct BBDebugStm __stmt_3 = {0x6b9c84beb0201680, 27, 0};
		bbOnDebugEnterStm(&__stmt_3);
		brl_max2d_DrawRect(0.000000000f,((BBFLOAT)bbt_y),640.000000f,((BBFLOAT)bbt_increment));
		struct BBDebugStm __stmt_4 = {0x6b9c84beb0201680, 28, 0};
		bbOnDebugEnterStm(&__stmt_4);
		bbt_y=(bbt_y+bbt_increment);
		bbOnDebugLeaveScope();
	}
	struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 30, 0};
	bbOnDebugEnterStm(&__stmt_2);
...
int _bb_main(){
	if (!_bb_main_inited) {
		...
		bbRegisterSource(0x6b9c84beb0201680, "C:/Users/Andrew/Documents/Blitzmax/Blitzball/Blitzball.bmx");
		...
		bbOnDebugEnterScope(&__scope);
		struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 2, 0};
		bbOnDebugEnterStm(&__stmt_0);
		brl_graphics_Graphics(640,480,0,60,0,-1,-1);
		struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 5, 0};
		bbOnDebugEnterStm(&__stmt_1);
		bbt_bat=(struct brl_max2d_image_TImage_obj*)brl_max2d_LoadImage((BBOBJECT)&_s11,-1);
		struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 6, 0};
		bbOnDebugEnterStm(&__stmt_2);
		bbt_ball=(struct brl_max2d_image_TImage_obj*)brl_max2d_LoadImage((BBOBJECT)&_s12,-1);
		struct BBDebugStm __stmt_3 = {0x6b9c84beb0201680, 9, 0};
		bbOnDebugEnterStm(&__stmt_3);
		bbt_px=256;
		struct BBDebugStm __stmt_4 = {0x6b9c84beb0201680, 10, 0};
		bbOnDebugEnterStm(&__stmt_4);
		bbt_py=400;
		struct BBDebugStm __stmt_5 = {0x6b9c84beb0201680, 11, 0};
		bbOnDebugEnterStm(&__stmt_5);
		bbt_lives=3;
		struct BBDebugStm __stmt_6 = {0x6b9c84beb0201680, 14, 0};
		bbOnDebugEnterStm(&__stmt_6);
		bbt_bx=0;
		struct BBDebugStm __stmt_7 = {0x6b9c84beb0201680, 15, 0};
		bbOnDebugEnterStm(&__stmt_7);
		bbt_by=0;
		struct BBDebugStm __stmt_8 = {0x6b9c84beb0201680, 16, 0};
		bbOnDebugEnterStm(&__stmt_8);
		bbt_sx=0;
		struct BBDebugStm __stmt_9 = {0x6b9c84beb0201680, 17, 0};
		bbOnDebugEnterStm(&__stmt_9);
		bbt_sy=0;
		struct BBDebugStm __stmt_10 = {0x6b9c84beb0201680, 33, 0};
		bbOnDebugEnterStm(&__stmt_10);
		bbt_score=0;
		struct BBDebugStm __stmt_11 = {0x6b9c84beb0201680, 36, 0};
		bbOnDebugEnterStm(&__stmt_11);
		brl_system_HideMouse();
		struct BBDebugStm __stmt_12 = {0x6b9c84beb0201680, 38, 0};
		...
		while(!(brl_polledinput_KeyHit(27)!=0) && !(brl_polledinput_AppTerminate()!=0)){
			...
			bbOnDebugEnterScope(&__scope);
			struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 40, 0};
			bbOnDebugEnterStm(&__stmt_0);
			bbt_m=&bbEmptyString;
			struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 41, 0};
			bbOnDebugEnterStm(&__stmt_1);
			brl_max2d_Cls();
			struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 43, 0};
			bbOnDebugEnterStm(&__stmt_2);
			_m_Blitzball_DrawGradient(24);
			struct BBDebugStm __stmt_3 = {0x6b9c84beb0201680, 46, 0};
			bbOnDebugEnterStm(&__stmt_3);
			brl_max2d_DrawImage((struct brl_max2d_image_TImage_obj*)bbt_ball,((BBFLOAT)bbt_bx),((BBFLOAT)bbt_by),0);
			struct BBDebugStm __stmt_4 = {0x6b9c84beb0201680, 47, 0};
			bbOnDebugEnterStm(&__stmt_4);
			brl_max2d_DrawImage((struct brl_max2d_image_TImage_obj*)bbt_bat,((BBFLOAT)bbt_px),((BBFLOAT)bbt_py),0);
			struct BBDebugStm __stmt_5 = {0x6b9c84beb0201680, 50, 0};
			bbOnDebugEnterStm(&__stmt_5);
			if(bbt_sx==0){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 51, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_m=&_s13;
				struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 52, 0};
				bbOnDebugEnterStm(&__stmt_1);
				brl_max2d_DrawText(bbt_m,((BBFLOAT)((640-brl_max2d_TextWidth(bbt_m))/2)),240.000000f);
				struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 53, 0};
				bbOnDebugEnterStm(&__stmt_2);
				bbt_m=bbStringConcat(bbStringConcat(&_s14,bbStringFromInt(bbt_lives)),&_s15);
				struct BBDebugStm __stmt_3 = {0x6b9c84beb0201680, 54, 0};
				bbOnDebugEnterStm(&__stmt_3);
				brl_max2d_DrawText(bbt_m,((BBFLOAT)((640-brl_max2d_TextWidth(bbt_m))/2)),254.000000f);
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_6 = {0x6b9c84beb0201680, 57, 0};
			bbOnDebugEnterStm(&__stmt_6);
			...
			struct BBDebugStm __stmt_7 = {0x6b9c84beb0201680, 58, 0};
			bbOnDebugEnterStm(&__stmt_7);
			brl_max2d_DrawText(bbt_m,((BBFLOAT)((640-brl_max2d_TextWidth(bbt_m))/2)),0.000000000f);
			struct BBDebugStm __stmt_8 = {0x6b9c84beb0201680, 61, 0};
			bbOnDebugEnterStm(&__stmt_8);
			bbt_px=brl_polledinput_MouseX();
			struct BBDebugStm __stmt_9 = {0x6b9c84beb0201680, 62, 0};
			bbOnDebugEnterStm(&__stmt_9);
			if((brl_polledinput_KeyHit(32)!=0) && (bbt_sx==0)){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 63, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_sx=4;
				struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 64, 0};
				bbOnDebugEnterStm(&__stmt_1);
				bbt_sy=4;
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_10 = {0x6b9c84beb0201680, 68, 0};
			bbOnDebugEnterStm(&__stmt_10);
			if(bbt_px<0){
				struct BBDebugScope __scope = {
					BBDEBUGSCOPE_LOCALBLOCK,
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 69, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_px=0;
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_11 = {0x6b9c84beb0201680, 71, 0};
			bbOnDebugEnterStm(&__stmt_11);
			if(bbt_px>512){
				struct BBDebugScope __scope = {
					BBDEBUGSCOPE_LOCALBLOCK,
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 72, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_px=512;
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_12 = {0x6b9c84beb0201680, 76, 0};
			bbOnDebugEnterStm(&__stmt_12);
			bbt_bx=(bbt_bx+bbt_sx);
			struct BBDebugStm __stmt_13 = {0x6b9c84beb0201680, 77, 0};
			bbOnDebugEnterStm(&__stmt_13);
			bbt_by=(bbt_by+bbt_sy);
			struct BBDebugStm __stmt_14 = {0x6b9c84beb0201680, 78, 0};
			...
			if((bbt_bx<0) || (bbt_bx>616)){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 79, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_sx=(bbt_sx*-1);
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_15 = {0x6b9c84beb0201680, 81, 0};
			...
			if(bbt_by<0){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 82, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_by=0;
				struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 83, 0};
				bbOnDebugEnterStm(&__stmt_1);
				bbt_sy=(bbt_sy*-1);
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_16 = {0x6b9c84beb0201680, 86, 0};
			...
			if(bbt_by>bbt_py){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 87, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_lives=(bbt_lives-1);
				struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 88, 0};
				bbOnDebugEnterStm(&__stmt_1);
				bbt_bx=0;
				struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 89, 0};
				bbOnDebugEnterStm(&__stmt_2);
				bbt_by=0;
				struct BBDebugStm __stmt_3 = {0x6b9c84beb0201680, 90, 0};
				bbOnDebugEnterStm(&__stmt_3);
				bbt_sx=0;
				struct BBDebugStm __stmt_4 = {0x6b9c84beb0201680, 91, 0};
				bbOnDebugEnterStm(&__stmt_4);
				bbt_sy=0;
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_17 = {0x6b9c84beb0201680, 95, 0};
			...
			if(brl_max2d_ImagesCollide((struct brl_max2d_image_TImage_obj*)bbt_bat,bbt_px,bbt_py,0,(struct brl_max2d_image_TImage_obj*)bbt_ball,bbt_bx,bbt_by,0)!=0){
				...
				bbOnDebugEnterScope(&__scope);
				struct BBDebugStm __stmt_0 = {0x6b9c84beb0201680, 96, 0};
				bbOnDebugEnterStm(&__stmt_0);
				bbt_by=(bbt_by-1);
				struct BBDebugStm __stmt_1 = {0x6b9c84beb0201680, 97, 0};
				bbOnDebugEnterStm(&__stmt_1);
				bbt_sy=(bbt_sy*-1);
				struct BBDebugStm __stmt_2 = {0x6b9c84beb0201680, 98, 0};
				bbOnDebugEnterStm(&__stmt_2);
				bbt_score=(bbt_score+1);
				bbOnDebugLeaveScope();
			}
			struct BBDebugStm __stmt_18 = {0x6b9c84beb0201680, 101, 0};
			bbOnDebugEnterStm(&__stmt_18);
			brl_graphics_Flip(-1);
			bbOnDebugLeaveScope();
		}
		struct BBDebugStm __stmt_13 = {0x6b9c84beb0201680, 104, 0};
		bbOnDebugEnterStm(&__stmt_13);
